  ...
  data() {
    return {
      dwt: {
        obj: null,
        id: "dwtObject",
        licenseKey: "t0153KQMAAAu0iPplsrNRwO0GfRvA3quvK5RpNOuVLfK5fpfZm7iAbtYBCZGvzKa5XFEdqFrozLp5yikXez1E6Tj9J+u7jb9sJI8N4RisReR/JZtCY3iYTzFaDR7qXKbc9WS+OH506jSGE0bHpvSnb9zMZw/pZ24NJ4yOjZu5MX6f7UEi7Haw1czSM5wwOjY1890oU5Co6QfB7J54",
      },
      viewer: {
        id: "dwtViewer",
        width: "100%",
    ...
    handleTabChange(key) {
      let loadOnSwitch = () => {
        switch (key) {
          ...
          case 1: {
            this.$refs["webcam-panel"].setupWebcam(
              dwt.Lib.detect.ssl,
              dwt.EnumDWT_VideoRotateMode,
              this.dwt.obj
            );
            break;
          }
          case 2: {
            this.$refs["ocr-panel"].setupOcr(
              dwt.WebTwainEnv.ResourcesPath,
              true,
              this.dwt.obj,
              dwt.Lib
            );
